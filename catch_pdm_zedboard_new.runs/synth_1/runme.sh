...
HD_PWD='D:/Vivado/catch_pdm_zedboard_new/catch_pdm_zedboard_new.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log MYIP_TOP.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source MYIP_TOP.tcl
